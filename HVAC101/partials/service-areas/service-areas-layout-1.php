	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md">
				...
				<h3 class="section_heading text-center nopadding"><?php echo get_option('home-service-areas-title'); ?></h3>

				<div class="service-areas-content-wrapper text-center bg-primary-color">
