...
public function widget( $args, $instance ) {
   ...
   echo '<div class="widget-text wp_widget_plugin_box">';
	...
	$date_checkbox =  ($instance['date_checkbox'] )? $instance['date_checkbox'] : false;
	$thumbnail_checkbox = ($instance['thumbnail_checkbox'] ) ? $instance['thumbnail_checkbox'] : false;

	ob_start();

	set_query_var( 'date_checkbox', $date_checkbox );
	set_query_var( 'thumbnail_checkbox', $thumbnail_checkbox );
