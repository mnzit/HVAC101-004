...
function hvac101_scripts() {
	...
	wp_enqueue_style( 'hvac101-owl-style', get_template_directory_uri() . '/css/owl-carousel.css', array(), '1.0.0' );

	wp_enqueue_style( 'hvac101-wow-style', get_template_directory_uri() . '/css/animate.css', array(), '1.0.0' );

	wp_enqueue_style( 'hvac101-style', get_template_directory_uri() . '/style.css', array(), '1.0.0' );
	...
	require get_template_directory() . '/inc/dynamic_styles.php';

	$custom_css= all_dynamic_css();

	wp_add_inline_style( 'hvac101-style', $custom_css );
