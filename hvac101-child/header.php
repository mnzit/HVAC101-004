		...
		<div class="logo-row">
			<div class="container">
				<div class="row align-items-center justify-content-end">
					...
					<?php if(get_option('header-content-1')!=""): ?>
					<div class="col-sm header-box box-1">
						<?php echo get_option('header-content-1'); ?>
					</div>
					<?php endif; ?>
					<?php if(get_option('header-content-2')!=""): ?>
					<div class="col header-box box-2">
						<?php echo get_option('header-content-2'); ?>
					</div>
					<?php endif; ?>
					<?php if(get_option('header-content-3')!=""): ?>
					<div class="col header-box box-3">
						<?php echo get_option('header-content-3'); ?>
					</div>
					<?php endif; ?>
